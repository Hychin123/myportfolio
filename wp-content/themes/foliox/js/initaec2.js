...
function foliox_tm_nav_bg(){
	...
	jQuery(window).on('scroll',function(){
		...
		var menu_mobile	 		= jQuery('.foliox_tm_mobile_menu');
		var progress	 	= jQuery('.progressbar');
		var WinOffset		= jQuery(window).scrollTop();
		
		if(WinOffset >= 100){
			menu.addClass('animate');
			menu_mobile.addClass('animate');
			progress.addClass('animate');
		}else{
			menu.removeClass('animate');
			menu_mobile.removeClass('animate');
...
function foliox_tm_modalbox_news(){
	...
	button.on('click',function(){
		...
		modalBox.find('.news_popup_informations').prepend('<div class="image"><img src="https://shtheme.com/demosd/foliox/wp-content/uploads/2023/05/4-2.jpg" alt="" /><div class="main" data-img-url="'+image+'"></div></div>');
...
function foliox_tm_modalbox_portfolio(){
	...
	button.off().on('click',function(){
		...
		modalBox.addClass('opened');
		modalBox.find('.description_wrap').html(content);
		modalBox.find('.popup_details').prepend('<div class="top_image"><img src="https://shtheme.com/demosd/foliox/wp-content/uploads/2023/05/4-2.jpg" alt="" /><div class="main" data-img-url="'+image+'"></div></div>');
